...
const Footer = () => (
  <section className={`${styles.flexCenter}  flex-col`}>
    <div className={`flex items-start mt-[1rem] justify-center md:flex-row flex-col mb-[0.5rem]    flex-wrap`}>
      
      <div  className="mr-[4rem] pb-[2rem]   flex flex-col ss:my-0 my-[1rem] min-w-[150px]">
        <h4 className="font-poppins font-medium text-[2rem] leading-[27px] mb-[1.5rem] text-white">
        {ContactInfo.title}
        </h4>
        <div >
          <div >
            <span className="text-almostWhite text-[1.3rem] mb-[1rem] ">Address</span>
          ...
          <div className=" mt-[0.5rem]">
            <span className="text-almostWhite text-[1.3rem] mb-[1rem] ">Phone</span>
            <div className="text-dimWhite flex flex-col ml-[1rem] leading-[1.5rem]">
